...
Address input forms in the UK should contain two address levels and one, two or three address lines, depending on the address. A complete address would look like so:
...
- `address-level1`: The county - "Whatshire" in this case.
